...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { error, message } = await signUp(email, password, name.trim());
      ...
      <Card className="w-full max-w-md bg-gray-900 border-green-500/20">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-gray-400">
            Join WakeCall and never oversleep again
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="relative">
            <div className="absolute inset-0 flex items-center">
              <Separator className="w-full bg-green-500/20" />
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="bg-gray-800 border-green-500/30 text-white pr-10"
                  disabled={isLoading || loading}
                />
                <Button
                  type="button"
            ...
            <Button
              ...
              disabled={isLoading || loading || !passwordValidation.isValid}
            >
